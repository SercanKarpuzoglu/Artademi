...
/**
 * Brans listesi icin dinamik (opsiyonel) filtreler. Criteria tabanli olduklari icin:
 * <ul>
...
public final class BranchSpecifications {
    ...
    public static Specification<Branch> hasAktif(Boolean aktif) {
    ...
    public static Specification<Branch> matchesText(String q) {
